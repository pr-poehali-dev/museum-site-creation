...
const programs = [
  {
    ...
    description: 'Интерактивные экскурсии, адаптированные для разных возрастов',
    icon: 'Users',
    age: '6-17 лет',
  },
  {
    title: 'Мастер-классы',
    description: 'Практические занятия по истории искусства и ремеслам',
    icon: 'Pencil',
    age: '8-16 лет',
  },
  {
    title: 'Образовательные квесты',
    description: 'Увлекательные игры-квесты по экспозициям музея',
    icon: 'Map',
    age: '10-15 лет',
  },
  {
    title: 'Лекции и презентации',
    description: 'Тематические лекции для старшеклассников',
    icon: 'BookOpen',
    age: '14-17 лет',
  },
];
